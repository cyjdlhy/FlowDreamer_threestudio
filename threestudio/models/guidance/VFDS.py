...
class RectifiedFlowGuidance(BaseModule):
    ...
    def forward(
        ...
        **kwargs,
        ...
        grad, noise, weights = self.compute_grad_vfds(
        ...
        target = (grad).detach()
        loss_vfds = weights * F.mse_loss(noise - latents, target, reduction="mean") / batch_size
        return {
            "loss_vfds": loss_vfds,
            "grad_norm": grad.norm(),
